          ...
          <el-row>
            <el-col :span="11">
              <el-form-item label-width="60px" label="预览图:" class="postInfo-container-item">
                <upload-image v-model="postForm.imageUrl" class="postInfo-container-input"/>
              </el-form-item>
            </el-col>
...
export default {
  name: 'ArticleDetail',
  components: { Tinymce, mavonEditor, Sticky, CommentDropdown, TopDropdown, UploadImage },
  props: {
    isEdit: {
      type: Boolean,
      default: false
